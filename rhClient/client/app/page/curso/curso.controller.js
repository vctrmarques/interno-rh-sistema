            ...
            var lista = {
                ...
                table: {
                    ...
                    body: [
                        ...
                        { text: 'Grau Acadêmico', fontSize: 10, fillColor: 'lightgray', style: 'tableHeader', alignment: 'center' },
                        { text: 'Área de Formação', fontSize: 10, fillColor: 'lightgray', style: 'tableHeader', alignment: 'center' }
                        ]
                    ]
                },
                layout: {
