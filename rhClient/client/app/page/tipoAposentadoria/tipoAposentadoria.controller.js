(function () {
    ...
    angular.module('app.page')
        .controller('tipoAposentadoriaCtrl', ['configValue', '$scope', '$mdToast', '$mdDialog', '$rootScope', 'GenericoService', tipoAposentadoriaCtrl]);

    function tipoAposentadoriaCtrl(configValue, $scope, $mdToast, $mdDialog, $rootScope, GenericoService) {
        ...
        $scope.loadList = function () {
            ...
            $scope.promise = GenericoService.GetAll('/tiposAposentadoria', config).then(
                function (response) {
                    if (response.status === 200) {
