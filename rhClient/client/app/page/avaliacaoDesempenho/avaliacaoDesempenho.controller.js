(function () {
    ...
    angular.module('app.page')
        .controller('avaliacaoDesempenhoCtrl', ['configValue', '$scope', '$mdToast', '$mdDialog', '$rootScope', 'GenericoService', avaliacaoDesempenhoCtrl]);

    function avaliacaoDesempenhoCtrl(configValue, $scope, $mdToast, $mdDialog, $rootScope, GenericoService) {
        ...
        $scope.loadList = function () {
            ...
            $scope.promise = GenericoService.GetAll('/avaliacaoDesempenho', config).then(
                function (response) {
                    if (response.status === 200) {
        ...
        $scope.deleteItem = function () {
            $rootScope.$broadcast('preloader:active');
            GenericoService.Delete('/avaliacaoDesempenho/' + $scope.idToDelete, function (response) {
                $rootScope.$broadcast('preloader:hide');
                if (response.status === 200) {
        ...
        $scope.showRelatorio = function () {
            ...
            GenericoService.GetAll('/avaliacaoDesempenho/relatorio', config).then(function (response) {
                if (response.status === 200) {
