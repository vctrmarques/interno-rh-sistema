        ...
        function getDocDefinition(content, dataURL) {
            ...
            var lista = {
                ...
                table: {
                    ...
                    body: [
                        ...
                        { text: 'Horário', fontSize: 10, fillColor: 'lightgray', style: 'tableHeader', alignment: 'center' },
                        { text: 'Jornada Diária (h)', fontSize: 10, fillColor: 'lightgray', style: 'tableHeader', alignment: 'center' },
            ...
            for (i = 0; i < content.length; i++) {
                ...
                if(!element.horarioFlexivel && !element.intervaloFlexivel){
                    var text =  $filter('date')(element.horarioFlexivelInicio, 'HH:mm') + ' às ' + 
                    $filter('date')(element.horarioFlexivelInicio, 'HH:mm') + ' | ' +
                    $filter('date')(element.intervaloFlexivelFim, 'HH:mm') + ' às ' +
