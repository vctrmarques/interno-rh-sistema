(function () {
    ...
    angular.module('app.page')
        .controller('observacaoDocCtrl', ['configValue', '$scope', '$rootScope', '$location', 'GenericoService', observacaoDocCtrl]);

    function observacaoDocCtrl(configValue, $scope, $rootScope, $location, GenericoService) {
