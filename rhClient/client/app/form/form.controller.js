(function () {
    ...
    function InputCtrl ($scope) {
        ...
        $scope.user = {
            ...
            state: 'CA',
            statePtBr: '',
            biography: 'Google LLC é uma empresa multinacional de serviços online e software dos Estados Unidos. O Google hospeda e desenvolve uma série de serviços.',
            postalCode: ''
        };
    ...
    function MaterialAutocompleteCtrl ($scope, $timeout, $q, $log) {
        ...
        function newState(state) {
            $scope.states.push({"value":state,"display":state});
            $scope.selectedItem = {"value":state,"display":state};
