...
angular.module("app").directive('multipleDatePicker', function () {
    return {
        restrict: 'AE',
        scope: {
            /*
             ...
             * Will be called when month changed
             * Param newYear/oldYear will be the first day of month at midnight
             * */
            yearChanged: '=?',            
            /*
        ...
        link: function (scope) {
            ...
            scope.changeYear = function (year) {
                scope.year = scope.month.year(parseInt(year, 10));
                
                if (typeof scope.yearChanged == 'function') {
                    scope.yearChanged(scope.year);
                }
