(function () {
    ...
    angular.module('app.core').directive('selectComponent', ['$mdToast', '$rootScope', 'RestService', '$filter',
        function ($mdToast, $rootScope, RestService, $filter) {
            return {
                restrict: 'E',
                template: `
                <md-select data-md-container-class="selectdemoSelectHeader" md-on-close="searchTerm = ''"
